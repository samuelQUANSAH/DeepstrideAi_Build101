# Afrophysiques - Ultra-Modern Reactive E-commerce Store

Welcome to the **Afrophysiques** project repository. This project is a comprehensive re-architecture of the Afrophysiques web application, transforming it from a legacy layout into an ultra-modern, reactive, and responsive e-commerce experience. 

The application utilizes **Shopify** for inventory and product management, coordinated via a multi-agent orchestration stack.
